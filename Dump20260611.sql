...
--
-- Host: 127.0.0.1    Database: pixelforgestore
-- ------------------------------------------------------
...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ '32e9ad11-3eb8-11f1-ae27-7824afc7d244:1-36';
...
CREATE TABLE `detalle_pedidos` (
  ...
  CONSTRAINT `detalle_pedidos_ibfk_2` FOREIGN KEY (`id_producto`) REFERENCES `productos` (`id_producto`) ON UPDATE CASCADE,
...
-- Dump completed on 2026-06-11 21:21:34
